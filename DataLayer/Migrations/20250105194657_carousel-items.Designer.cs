...
namespace CourseApi.DataLayer.Migrations
{
    ...
    [Migration("20250105194657_carousel-items")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CourseApi.DataLayer.DataContext.Entities.CarouselItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CourseApi.DataLayer.DataContext.Entities.InstructorDetail", b =>
                {
                    b.Property<Guid>("InstructorId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourseApi.DataLayer.DataContext.Entities.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("CourseApi.DataLayer.DataContext.Entities.Course", b =>
                {
                    b.HasOne("CourseApi.DataLayer.DataContext.Entities.InstructorDetail", "Instructor")
            ...
            modelBuilder.Entity("CourseApi.DataLayer.DataContext.Entities.InstructorDetail", b =>
                {
                    b.HasOne("CourseApi.DataLayer.DataContext.Entities.AppUser", "InstructorUser")
                        .WithOne("InstructorDetail")
                        .HasForeignKey("CourseApi.DataLayer.DataContext.Entities.InstructorDetail", "InstructorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
